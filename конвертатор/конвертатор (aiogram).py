...
async def summa(message: types.Message):
    ...
    try:
        ...
        btn11 = types.InlineKeyboardButton("JPY/USD", callback_data="jpy/cad")
        btn12 = types.InlineKeyboardButton("USD/JPY", callback_data="eur/jpy")
